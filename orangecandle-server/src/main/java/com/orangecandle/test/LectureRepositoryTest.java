...
public class LectureRepositoryTest {
	...
	public void savesCollectionCorrectly() throws Exception {
		...
		List<Lecture> result = repository.save(Arrays.asList(lectureOne, lectureTwo, lectureThree));
	...
	public void testUpdateLectureCode() {
		...
		//update user name?
		assertThat(updatedLecture.getLectureName(), is(foundLecture.getLectureName()));
	}
	@Test
	public void returnsAllSortedCorrectly() throws Exception {

		flushTestLecture();
		List<Lecture> result = repository.findAll(new Sort(Sort.Direction.ASC, "name"));
		//is correctly sorted
		assertThat(result, is(notNullValue()));
